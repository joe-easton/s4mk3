...
Traktor.Stripe {
  ...
  AppProperty { id: trackLength;           path: "app.traktor.decks." + deckInfo.deckId + ".track.content.track_length" }
  AppProperty { id: propTrackSampleLength; path: "app.traktor.decks." + deckInfo.deckId + ".track.content.sample_count"     }
  ...
  Rectangle {
    ...
    AppProperty { id: trackEndWarning; path: "app.traktor.decks." + deckInfo.deckId + ".track.track_end_warning" }
  ...
  Repeater {
    ...
    Widgets.Hotcue {
      ...
      AppProperty { id: pos;    path: "app.traktor.decks." + deckInfo.deckId + ".track.cue.hotcues." + (index + 1) + ".start_pos" }
      AppProperty { id: length; path: "app.traktor.decks." + deckInfo.deckId + ".track.cue.hotcues." + (index + 1) + ".length"    }
  ...
  Widgets.ActiveCue {
    ...
    AppProperty { id: aciveLength;  path: "app.traktor.decks." + deckInfo.deckId + ".track.cue.active.length"   }
    x:               roundedX         
    isSmall:         true
    anchors.bottom:  parent.bottom
    anchors.bottomMargin: 2
  ...
  Rectangle {
    ...
    AppProperty { id: elapsedTime; path: "app.traktor.decks." + deckInfo.deckId + ".track.player.elapsed_time" }
    x:                 roundedX            
    anchors.top:       parent.top
    height:            28
